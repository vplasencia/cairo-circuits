...
fn main(
    ...
    // NOTE: message_id is intentionally NOT zero-checked here. RLN message IDs
    // are 0-indexed (valid range: 0 <= message_id < user_message_limit), so
    // message_id = 0 is the first valid message in any epoch.
