...
mod tests {
    ...
    fn test_generate_y_root_and_nullifier() {
        // Depth-2 binary Merkle tree used in this test:
        //   leaf = rate_commitment = poseidon2(poseidon1(secret=1), user_message_limit=3)
        //   level-0 sibling: 2
        //   level-1 sibling: 984631471205578712614553929895140960202851439944671757216493909002271097326
    ...
    fn test_accepts_message_id_last_valid_index() {
        ...
        let a1 = super::poseidon3(secret, scope, message_id);
        let expected_y = a1 * x + secret;
